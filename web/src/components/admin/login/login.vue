    ...
    methods: {
      /*handleLogin() {
        ...
        this.$refs.AccountFrom.validate((valid) => {
          if (valid) {
            this.loading = true;
            let params = {username: this.account.username, password: this.account.pwd};
            ...
            login(params).then(res => {
              ...
              if (res && res.code == 0) {
                ...
                that.$message.error({showClose: true, message: res.msg || '登录失败', duration: 2000});
              }
            })
